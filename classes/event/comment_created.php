...
/**
 * The assignsubmission_moderatorchat comment created event.
 *
 * @package    assignsubmission_moderatorchat
 */

namespace assignsubmission_moderatorchat\event;
defined('MOODLE_INTERNAL') || die();

/**
 * The assignsubmission_moderatorchat comment created event class.
 *
 * @package    assignsubmission_moderatorchat
 * @since      Moodle 2.7
