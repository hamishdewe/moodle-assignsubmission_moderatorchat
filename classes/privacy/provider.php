...
namespace assignsubmission_moderatorchat\privacy;
...
class provider implements metadataprovider,
    ...
    public static function get_context_for_userid_within_submission(int $userid, contextlist $contextlist) {
        $sql = "SELECT contextid
                 ...
                 WHERE component = :component
                       ...
                       AND userid = :userid";
        $params = ['userid' => $userid, 'component' => 'assignsubmission_moderatorchat', 'commentarea' => 'submission_moderatorchat'];
    ...
    public static function get_userids_from_context(\core_privacy\local\request\userlist $userlist) {
        ...
        comments_provider::get_users_in_context_from_sql($userlist, 'c', 'assignsubmission_moderatorchat', 'submission_moderatorchat',
                $context->id);
    }
    ...
    public static function export_submission_user_data(assign_plugin_request_data $exportdata) {
        $component = 'assignsubmission_moderatorchat';
        $commentarea = 'submission_moderatorchat';
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        comments_provider::delete_comments_for_all_users($requestdata->get_context(), 'assignsubmission_moderatorchat',
                'submission_moderatorchat');
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $exportdata) {
        ...
        $contextlist = new \core_privacy\local\request\approved_contextlist($exportdata->get_user(), 'assignsubmission_moderatorchat',
            [$exportdata->get_context()->id]);
        comments_provider::delete_comments_for_user($contextlist, 'assignsubmission_moderatorchat', 'submission_moderatorchat');
    }
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        $userlist = new \core_privacy\local\request\approved_userlist($deletedata->get_context(), 'assignsubmission_moderatorchat',
                $deletedata->get_userids());
        comments_provider::delete_comments_for_users($userlist, 'assignsubmission_moderatorchat', 'submission_moderatorchat');
    }
